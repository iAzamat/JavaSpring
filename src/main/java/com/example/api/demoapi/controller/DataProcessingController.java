...
public class DataProcessingController {
    ...
    @Autowired
    public DataProcessingController(DataProcessingService dataProcessingService, RegistrationService registrationService, NotificationService notificationService) {
    ...
    @RequestMapping(value = "/filter/{age}", method = RequestMethod.POST)
    ...
    public ResponseEntity<List<User>> deleteUser(@RequestParam("id") long id) {
