package ru.gb.homework10.config;
...
import ru.gb.homework10.security.MySimpleUrlAuthenticationSuccessHandler;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .sessionManagement(httpSecuritySessionManagementConfigurer ->
                        httpSecuritySessionManagementConfigurer.sessionFixation()
                                .migrateSession().sessionCreationPolicy(SessionCreationPolicy.ALWAYS)
